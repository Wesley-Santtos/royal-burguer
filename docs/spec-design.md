...
- **Lanche do Momento (`.feature`):** bloco em `--cream` entre a barra de
  categorias e o cardápio. Selo dourado "⭐ Lanche do Momento", **vídeo** do
  hambúrguer girando (loop, mudo, autoplay) em palco quadrado de até 320px com
  cantos 22px e sombra, nome (Baloo 2), descrição, preço em `--brown`, botão
  WhatsApp.
